...
- **OpenAI API:** fatturazione e crediti API sono separati da ChatGPT. `gpt-4o-transcribe` è circa **$0,006/min** (**$0,36/ora**); il modello di diarizzazione usato dall'app, `gpt-4o-transcribe-diarize`, è quotato a **$2,50/M token input** e **$10/M token output**. La classificazione visiva usa `gpt-5.6-luna` (**$0,20/M input**, **$1,20/M output**); il report testuale usa `gpt-4o-mini` (**$0,15/M input**, **$0,60/M output**) con una sola copia compatta dei segmenti trascritti. Consultare [prezzi OpenAI API](https://developers.openai.com/api/docs/pricing) e la [scheda del modello di diarizzazione](https://developers.openai.com/api/docs/models/gpt-4o-transcribe-diarize).
