...
UNSAFE_MATERIAL_SOURCES = [
    ...
    ("file", "/private/tmp/PRIVATE_SOURCE_SENTINEL.pdf"),
    ("file", "/var/tmp/PRIVATE_SOURCE_SENTINEL.pdf"),
    ("file", "/var/folders/random/PRIVATE_SOURCE_SENTINEL.pdf"),
    ("file", "/data/bunny-video-ab12_cd3/PRIVATE_SOURCE_SENTINEL.pdf"),
    ("file", "archive/material-a1b2c3d4/PRIVATE_SOURCE_SENTINEL.pdf"),
    ("file", "archive/material-match-a1b2c3d4/PRIVATE_SOURCE_SENTINEL.pdf"),
    ("file", "archive/deck-pages-a1b2c3d4/PRIVATE_SOURCE_SENTINEL.pdf"),
    ("file", "archive/media-a1b2c3d4/PRIVATE_SOURCE_SENTINEL.pdf"),
    ("file", "archive/split-a1b2c3d4/PRIVATE_SOURCE_SENTINEL.pdf"),
]
